...
import me.yejin.springboot3blogldap.config.jwt.JwtFactory;
import me.yejin.springboot3blogldap.config.jwt.JwtProperties;
...
class TokenApiControllerTest {
  ...
  public void createNewAccessToken() throws Exception {
    ...
    refreshTokenRepository.save(new RefreshToken(testUser.getId().toString(), refreshToken));
